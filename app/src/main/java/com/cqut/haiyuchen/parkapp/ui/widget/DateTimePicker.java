 ...
 *
 * @Override public void onClick(ChangePasswordView v) { DateTimePickDialogUtil
...
public class DateTimePicker implements OnDateChangedListener, OnTimeChangedListener {
  ...
  public AlertDialog dateTimePicKDialog(final EditText inputDate) {
    LinearLayout dateTimeLayout =
        (LinearLayout) activity.getLayoutInflater().inflate(R.layout.widget_date_time_picker, null);
